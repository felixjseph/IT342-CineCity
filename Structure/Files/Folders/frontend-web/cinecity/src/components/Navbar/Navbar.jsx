            ...
            <nav className="border-b-2 border-opacity-30 border-gray-200/30 px-16 py-2">
                <div className="flex">
                    ...
                    <ul className="text-white flex items-center">
                        ...
                        <li className="mx-4 cursor-pointer relative after:content-[''] after:block after:w-0 after:h-[2px] after:bg-green-500 after:transition-all after:duration-300 hover:after:w-full">MOVIES</li>
