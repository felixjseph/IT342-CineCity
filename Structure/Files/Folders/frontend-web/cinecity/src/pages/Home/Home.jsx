...
export default function Home() {
  ...
  return (
    <div>
      ...
      >
        <div className="bg-black/80 p-10 rounded-lg text-center max-w-4xl shadow-lg">
          ...
          <button
            className="px-8 py-4 bg-green-500 text-black rounded-full text-lg font-semibold hover:scale-105 hover:bg-green-600 transition duration-300 shadow-md"
      ...
      <div class="py-4 bg-white">
        <div class="max-w-5xl max-lg:max-w-2xl mx-auto h-[80vh]">
          <div class="max-w-2xl mx-auto text-center">
            <h2 class="text-black text-4xl font-bold mt-20">Meet our team</h2>
            <p class="text-black text-sm mt-6 leading-relaxed">Our team of skilled full-stack developers is dedicated to delivering innovative and efficient solutions. With expertise in both front-end and back-end technologies, we ensure seamless and user-friendly experiences for all our projects.</p>
          </div>

          <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 max-md:justify-center mt-12 max-md:max-w-xs mx-auto">
            <div class="border rounded-md overflow-hidden">
              <img src="https://readymadeui.com/team-1.webp" class="w-full object-contain aspect-square object-top bg-gray-200" />

              <div class="p-4">
                <h4 class="text-black text-base font-semibold">Amar Flores Jr</h4>
                <p class="text-black text-xs mt-1">Software Engineer</p>

                <div class="mt-4">
                  <p class="text-black text-sm leading-relaxed">A versatile full-stack developer specializing in building robust and efficient web applications.</p>
                </div>

                <div class="space-x-4 mt-4">
                  <button type="button"
                    class="cursor-pointer w-7 h-7 inline-flex items-center justify-center rounded-full border-none outline-none bg-blue-600 hover:bg-blue-700 active:bg-blue-600">
            ...
            <div class="border rounded-md overflow-hidden">
              ...
              <div class="p-4">
                <h4 class="text-black text-base font-semibold">Al Prince Llavan</h4>
                <p class="text-black text-xs mt-1">Software Engineer</p>

                <div class="mt-4">
                  <p class="text-black text-sm leading-relaxed">A full-stack developer with a passion for crafting seamless user experiences and scalable solutions.</p>
                </div>
            ...
            <div class="border rounded-md overflow-hidden">
              ...
              <div class="p-4">
                <h4 class="text-black text-base font-semibold">Felix Joseph Castañeda</h4>
                <p class="text-black text-xs mt-1">Software Engineer</p>

                <div class="mt-4">
                  <p class="text-black text-sm leading-relaxed">A dedicated full-stack developer focused on delivering end-to-end solutions with precision and creativity</p>
                </div>
